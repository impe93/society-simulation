...
tipo_A: tipo_A.o gestione_code.o gestione_semafori.o gestione_shm.o funzioni_A_B.o sem_protocol.o
	gcc -o tipo_A tipo_A.o gestione_code.o gestione_semafori.o gestione_shm.o funzioni_A_B.o sem_protocol.o
...
tipo_B: tipo_B.o gestione_code.o gestione_semafori.o gestione_shm.o funzioni_A_B.o funzioni_B.o sem_protocol.o
	gcc -o tipo_B tipo_B.o gestione_code.o gestione_semafori.o gestione_shm.o funzioni_A_B.o funzioni_B.o sem_protocol.o
...
gestore: gestore.o funzioni_gestore.o gestione_code.o gestione_semafori.o gestione_shm.o sem_protocol.o
	gcc -o gestore gestore.o funzioni_gestore.o gestione_code.o gestione_semafori.o gestione_shm.o sem_protocol.o
